...
const stats = [
  { value: "50+", label: "Projects", sub: "Residential & Commercial" },
  { value: "50+ Mn", label: "Sq.Ft.", sub: "Developed & Ongoing" },
  { value: "24,000+", label: "Units", sub: "Delivered & Underway" },
  { value: "700+", label: "Acres", sub: "Acquired & Licensed" },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="mt-6 text-muted-foreground max-w-3xl mx-auto text-lg leading-relaxed">
            ...
            environment, ensuring a better quality of life for generations to come. For us,
            sustainability isn't an afterthought — it's fundamental to our vision.
          </p>
        </motion.div>
